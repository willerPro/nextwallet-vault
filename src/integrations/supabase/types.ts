  ...
  public: {
    Tables: {
      ...
      contract_api_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "contract_api_settings_wallet_id_fkey"
            columns: ["wallet_id"]
            isOneToOne: false
            referencedRelation: "wallets"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      handle_referral_reward: {
        Args:
          | { referrer_id: string }
          | { referrer_id: string; amount_input: number }
        Returns: undefined
      }
      ...
      update_user_profits: {
        Args: { bot_profit_amount: number; contract_profit_amount: number }
        Returns: undefined
      }
    }
    Enums: {
